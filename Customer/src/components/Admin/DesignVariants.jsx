...
//                 // Agar editing mode hai to existing selected variants set karo
//                 if (isEditing && existingCustomProduct) {
//                     setSelectedVariantIds(existingCustomProduct.selectedDefaultVariants || []);

//                     // Custom variant details bhi set karo agar hain
...
//                     // Custom variants images bhi set karo agar hain
//                     if (existingCustomProduct.customVariants?.length > 0) {
//                         setCustomVariants(existingCustomProduct.customVariants.map(cv => ({
//                             _id: cv.id || `custom-${Date.now()}`,
//                             sku: cv.fileName || "Custom variant",
//                             basePrice: 0,
//                             weight: "N/A",
//                             size: "Custom",
//                             color: "Custom",
...
//                     }
//                 } else {
//                     // New mode: default select all variants
...
//     }, [productId, isEditing, existingCustomProduct]); // ✅ Dependencies add karo
...
//                         .filter(Boolean),
//                 })),
//                 customVariant: selectedCustomVariants[0]
//                     ? {
//                         enabled: true,
...
//                         tags: [],
//                     },
//                 customerDesignId: state?.customerDesignId || null, // ✅ Design ID yahan save hoga
...
//                 data = await updateCustomProduct(existingCustomProduct._id, {
//                     ...payload,
//                     customerDesignId: state?.customerDesignId // Make sure design ID is included
//                 });
//                 if (data.success) {
...
export default function DesignVariants() {
    ...
    //         // Prepare custom variants array
    //         const customVariantsArray = selectedCustomVariants.map((variant) => ({
    //             enabled: true,
    //             imageUrl: variant.image || "",
    //             publicId: variant.publicId || "",
    //             fileName: variant.fileName || "",
    //             // Common details apply to all
    ...
    //             productId,
    //             selectedDefaultVariants: selectedVariantIds,
    //             customVariants: customVariantsArray, // ✅ Array of custom variants
    //             // For backward compatibility - first custom variant as object
    //             customVariant: customVariantsArray[0] || {
    //                 enabled: false,
    //                 imageUrl: "",
    //                 publicId: "",
    //                 name: "",
