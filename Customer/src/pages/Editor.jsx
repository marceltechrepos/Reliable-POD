...
//     const captureFinalDesign = useCallback(async () => {
//         if (!designContainerRef.current) return null;
//         try {
//             // Hide borders during capture
...
//             // Convert to JPEG using html-to-image (same as admin editor)
...
//                         // ✅ Add capture here for update case
//                         if (designId) {
//                             const finalImageFile = await captureFinalDesign();
//                             if (finalImageFile) {
//                                 const formData = new FormData();
//                                 formData.append('image', finalImageFile);
//                                 const token = localStorage.getItem('token');
//                                 try {
//                                     const uploadRes = await fetch(`${import.meta.env.VITE_BASE_URL}/api/customer/designs/${designId}/final-image`, {
//                                         method: 'POST',
...
//                                         console.log('Final image uploaded');
//                                     } else {
//                                         console.warn('Final image upload failed:', uploadData.message);
//                                     }
//                                 } catch (err) {
