    ...
    const mapLayersToMockup = (layers, sourceMockupId, targetMockupId) => {
        ...
        return layers
            .map((layer) => {
                ...
                // --- Create mapped layer (preserve all original properties except dimensions/position) ---
                ...
                const mappedLayer = {
                    ...
                    // Keep perspective/corners if target print area supports it
