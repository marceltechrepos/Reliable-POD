...
//           <button onClick={() => navigate(`/user/edit/${productId}`)} className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-[#f05a28] text-white text-[13px] font-bold rounded hover:opacity-90 transition-all">
